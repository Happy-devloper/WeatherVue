# WeatherVue – A Fresh, Modern Weather Dashboard

![WeatherVue](https://img.shields.io/badge/version-2.0.0-blue) ![License MIT](https://img.shields.io/badge/license-MIT-green)
...
- 🌡️ **Temperature Unit Toggle** – Switch between Celsius and Fahrenheit. Preference is saved in `localStorage`.
- 📅 **5‑Day Forecast** – View a daily breakdown of upcoming weather.
...
- **Icons:** [Boxicons](https://boxicons.com/) & custom SVG weather icons
- **API:** [OpenWeather](https://openweathermap.org/api) (Current Weather + 5‑Day Forecast)
